package dev.aman.userservice.Security;
...
//                .username("user")
//                .password("$2a$12$KuuoG.fZHgONeFu4D.to4e4VDbzhcZgHl2x5C4SCLmSBjZvfYUjNO")
//                .roles("USER")
//                .build();
//
...
//    }
    ...
    /*
    So this custom claims.put is used to add any info to the token we want.
    Like I just put userId with the token.
     */
    @Bean
